...
def get_info() -> dict:
    ...
    return {
        ...
        "database": "ChromaDB",
        "collection": "saf_inspec_controls",
        "functions": ["add_to_memory", "query_memory"],
...
try:
    ...
    logger.info(
        "Successfully connected to ChromaDB and got collection 'saf_inspec_controls'."
    )
except Exception as e:
    logger.error(
        f"FATAL: Could not connect to ChromaDB. Ensure it is running. Error: {e}"
    )
    client = None
    collection = None
